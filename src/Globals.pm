...
#
#  $Revision: 5373 $
#  $Id: Globals.pm 5373 2007-01-22 10:49:28Z vcl_kore $
#
#########################################################################
##
...
our %EXPORT_TAGS = (
	...
	network => [qw($remote_socket $net $messageSender $charServer $conState $conState_tries $encryptVal $ipc $bus $lastPacketTime $masterServer $msg $msgOut $lastswitch $packetParser $bytesSent $bytesReceived)],
